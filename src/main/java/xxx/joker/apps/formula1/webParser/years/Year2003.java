...
public class Year2003 extends AWikiParser2018 {
    ...
    protected void parseQualify(String html, F1GranPrix gp) {
        ...
        for (JkTag tr : tbody.getChildren("tr")) {
            ...
            if(tdNum >= 5) {
                ...
                F1Driver d = retrieveDriver(tr.getChild(2).walkFirstChild("a", "b a").getText(), false);
                JkTag ttag = tr.getChild(3).walkFirstChild("a", "span a", "b a");
        ...
        for (JkTag tr : tbody.getChildren("tr")) {
            ...
            if(thNum == 1 && tdNum == 7) {
                ...
                if(gp.getQualifies().isEmpty()) {
                    ...
                    JkTag ttag = tr.getChild(posMap.get("Constructor")).walkFirstChild("a", "b a");
                    F1Team team = retrieveTeam(ttag.getText().replaceAll("-$", ""), false);
