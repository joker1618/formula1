package xxx.joker.libs.repository.wrapper;
...
import static xxx.joker.libs.repository.config.RepoConfig.CsvSeparator.*;
import static xxx.joker.libs.repository.util.RepoUtil.isOfClass;
...
public class FieldWrap {
    ...
    public boolean isEntityColl() {
        return collType != null && JkReflection.isInstanceOf(collType, RepoEntity.class);
    }
    ...
    private Object parseValue(String value) {
        ...
        if (isCollection()) {
            ...
            if (isSet()) {
                retVal = JkReflection.isInstanceOf(getCollType(), Comparable.class) ? JkConvert.toTreeSet(values) : JkConvert.toHashSet(values);
            } else {
                retVal = values;
            }
