...
public class Year1995 extends AWikiParser2018 {
...
//                q.getTimes().add(getQualTime(chTime));
                ...
                JkDuration q1Time = getQualTime(tr.getChild(posMap.containsKey("Q1 Time") ? posMap.get("Q1 Time") : posMap.get("Q1")));
                q.getTimes().add(q1Time);
                JkDuration q2Time = getQualTime(tr.getChild(posMap.containsKey("Q2 Time") ? posMap.get("Q2 Time") : posMap.get("Q2")));
